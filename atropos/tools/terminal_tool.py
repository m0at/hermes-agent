...
from .basic_tools import BashTool  # noqa: E402
...
class TerminalTool(Tool):
    ...
    def schema(self) -> ToolSchema:
        return ToolSchema(
            ...
            parameters={
                ...
                "background": {
                    "type": "boolean",
                    "description": "Run the command in the background (not supported in sandbox).",
                    "default": False,
                },
                "timeout": {
                    "type": "integer",
    ...
    def is_available(self) -> tuple[bool, str | None]:
        # The canonical terminal tool in atropos-agent is sandboxed; availability is governed
        # by whether the environment includes this tool and its own network policy.
        return True, None
    ...
    async def execute(
        ...
        if background:
            return ToolResult(success=False, error="background execution is not supported in sandboxed terminal")
