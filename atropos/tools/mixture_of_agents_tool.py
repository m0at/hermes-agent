...
# =============================================================================
# Atropos-Agent Tool wrapper (Hermes compatibility)
# =============================================================================
...
def _tool_result_from_json(output: str) -> ToolResult:
    ...
    if isinstance(data, dict) and "success" in data:
        ...
        if not ok:
            err = data.get("error") or "Mixture-of-Agents failed"
...
class MixtureOfAgentsTool(Tool):
    ...
    def schema(self) -> ToolSchema:
        return ToolSchema(
            ...
            description=(
                "Process extremely difficult problems requiring intense reasoning using a Mixture-of-Agents."
            ),
            parameters={
                "user_prompt": {
                    "type": "string",
                    "description": "The complex query or problem to solve using multiple models.",
                }
            },
    ...
    async def execute(self, user_prompt: str) -> ToolResult:
        output = await mixture_of_agents_tool(user_prompt=user_prompt)
